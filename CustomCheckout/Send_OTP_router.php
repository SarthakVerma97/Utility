...
$url = ENV . "/aoa-acquiring-biz/v2/otp/generate?mid=" . MID . "&orderId=" . $orderId;
...
<body>
    ...
    <form action="Validate_OTP_router.php" method="post" id="submit1" target="_blank">
        <input type="hidden" name="orderId" value="<?php echo $orderId ?>" id="orderId">

        <input type="hidden" name="TOKEN" value="<?php echo $TOKEN ?>" id="TOKEN">
        <button type="submit" form="submit1" value="Submit">Validate OTP</button>
